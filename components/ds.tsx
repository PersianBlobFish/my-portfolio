 ...
 *
 * USAGE FOR AI AGENTS:
 * These components handle all layout spacing and padding. Do NOT add manual
 * padding/margin classes when using them - the design system manages this.
 *
 * Use these existing components instead of creating new wrapper elements:
 *
 *   Layout    - Root <html> element (use in root layout.tsx only)
 *   Nav       - Navigation bar with built-in container and padding
 *   Main      - Primary content wrapper (<main> element)
 *   Section   - Semantic sections with vertical padding (py-2 sm:py-4)
 *   Container - Centered max-width container with padding (p-4 sm:p-6)
 *   Prose     - Rich text content with full typography styling
 *
 ...
 *   </Layout>
 *
 * All components accept className for additional styling via cn() merge.
 * Prose accepts isArticle (renders as <article>) and isSpaced (adds vertical spacing).
 */
